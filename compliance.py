...
def run_dashboard(blockchain, df, insights, anomalies, decrypted_data, non_compliant):
...
def main():
    ...
    run_dashboard(blockchain, analyzed_df, insights, anomalies, decrypted_data, non_compliant)
